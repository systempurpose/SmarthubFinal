    ...
    private void showHelperMessage() {
        ...
        new Handler().postDelayed(() -> {
            ...
            if (!reportFile.exists()) {
                ...
                tvMessage.setText("Please connect your device to the SmartHub desktop app and run a storage scan.");
                return;
            }

            tvStatus.setText("✅ Storage data ready");
            progressBar.setVisibility(ProgressBar.GONE);
            tvMessage.setVisibility(TextView.VISIBLE);
            tvMessage.setText("The Windows app is now displaying the storage analysis. Check the desktop for details.");
